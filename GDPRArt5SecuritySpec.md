...
| **Потом (опционально)** | SMS OTP — только если телефон добавлен в профиль | Не приоритет; Email OTP + TOTP App покрывают все случаи |
...
*GDPRArt5SecuritySpec.md v1.8 · Bestme · март 2026*  
