...
| Что происходит после | Все сессии кроме текущей завершаются. На email отправляется уведомление с IP и временем |
...
*GDPRArt5SecuritySpec.md v1.5 · Bestme · март 2026*  
