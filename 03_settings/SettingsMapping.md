...
## 4️⃣ Login & Security ⚖️ — Безопасность и вход
...
## 7️⃣ Your Data ⚖️ — Данные и права

| Пункт (UI) | Перевод | Обязательно / Опционально | По закону ⚖️ |
|---|---|---|---|
| **View your data** | Просмотреть мои данные | **Обязательно** | ⚖️ GDPR Art.15 — право доступа |
| **Download your data** | Скачать мои данные | **Обязательно** | ⚖️ GDPR Art.20 — переносимость |
| **Correct your data** | Исправить данные | **Обязательно** | ⚖️ GDPR Art.16 — право на исправление |
| **Deactivate account** | Деактивировать профиль | Опционально | — |
| **Analytics consent** | Согласие на аналитику | **Обязательно** (opt-in) | ⚖️ GDPR — только с явного согласия |
| **Ads consent** | Согласие на рекламу | **Обязательно** (opt-in) | ⚖️ GDPR — только с явного согласия |
| **Do Not Sell My Info** | Не продавать мои данные | **Обязательно** для США/CA | ⚖️ CCPA |
| **App permissions** | Разрешения приложения | **Обязательно** | 📱 App Store / Google Play |
...
| Геолокация в постах (выкл по умолчанию) | Опционально | ⚖️ GDPR — геоданные |
| Модерация комментариев (`comment_moderation`) | Нужно для функции | ⚖️ EU DSA Art.14 |
| Заглушённые ключевые слова | Опционально | — |
| Автовоспроизведение видео | Опционально | — |

---

> ⚠️ **Бизнес-профиль** — вынесен в отдельный документ. Настройки бизнес-профиля здесь не описаны.

---

## 8️⃣ Accessibility — Доступность и вид
...
## 9️⃣ Help & Support ⚖️ — Помощь и документы

> **Из дизайнерского экрана (1b7cc385):** Help & Support → Bestme help centre · Report a problem · Terms & Privacy policy

| Пункт | Обязательно / Опционально | По закону ⚖️ |
|---|---|---|
| Центр помощи (Bestme help centre) | Нужно для функции | — |
| Пожаловаться (Report a problem / content / user) | **Обязательно** | ⚖️ EU DSA Art.16 |
| Обжалование решения (Appeal) | **Обязательно** | ⚖️ EU DSA Art.20 |
